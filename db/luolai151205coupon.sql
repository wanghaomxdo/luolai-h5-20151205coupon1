...
/*================================= 建立表空间及对应dba*/
 -- create user
 GRANT USAGE ON *.* TO 'luolai151205cp'@'localhost' IDENTIFIED BY 'luolai151205cp' WITH GRANT OPTION;
 -- create database
 CREATE DATABASE luolai151205cp CHARACTER SET  utf8  COLLATE utf8_general_ci;
 ...
 GRANT SELECT,INSERT,UPDATE,DELETE,CREATE,DROP,LOCK TABLES ON luolai151205cp.*  TO 'luolai151205cp'@'localhost' IDENTIFIED BY 'luolai151205cp';
